    ...
    SELECT
        ...
        CASE
            WHEN
                ...
                (CASE WHEN (a.ASIAN_DETAILED_CATEGORIES IS NOT NULL /* Add check for non-empty VARIANT if needed */) OR (a.ASIAN_WRITE_IN IS NOT NULL AND a.ASIAN_WRITE_IN != '') THEN 1 ELSE 0 END) +
                (CASE WHEN (a.BLACK_OR_AFRICAN_AMERICAN_DETAILED_CATEGORIES IS NOT NULL /* Add check for non-empty VARIANT if needed */) OR (a.BLACK_OR_AFRICAN_AMERICAN_WRITE_IN IS NOT NULL AND a.BLACK_OR_AFRICAN_AMERICAN_WRITE_IN != '') THEN 1 ELSE 0 END) +
                ...
                (CASE WHEN (a.MIDDLE_EASTERN_OR_NORTH_AFRICAN_DETAILED_CATEGORIES IS NOT NULL /* Add check for non-empty VARIANT if needed */) OR (a.MIDDLE_EASTERN_OR_NORTH_AFRICAN_WRITE_IN IS NOT NULL AND a.MIDDLE_EASTERN_OR_NORTH_AFRICAN_WRITE_IN != '') THEN 1 ELSE 0 END) +
                (CASE WHEN (a.NATIVE_HAWAIIAN_OR_PACIFIC_ISLANDER_DETAILED_CATEGORIES IS NOT NULL /* Add check for non-empty VARIANT if needed */) OR (a.NATIVE_HAWAIIAN_OR_PACIFIC_ISLANDER_WRITE_IN IS NOT NULL AND a.NATIVE_HAWAIIAN_OR_PACIFIC_ISLANDER_WRITE_IN != '') THEN 1 ELSE 0 END) +
                (CASE WHEN (a.WHITE_DETAILED_CATEGORIES IS NOT NULL /* Add check for non-empty VARIANT if needed */) OR (a.WHITE_WRITE_IN IS NOT NULL AND a.WHITE_WRITE_IN != '') THEN 1 ELSE 0 END) > 1
            THEN 'Multi-Race'
            ...
            WHEN (a.ASIAN_DETAILED_CATEGORIES IS NOT NULL /* Add check for non-empty VARIANT if needed */) OR (a.ASIAN_WRITE_IN IS NOT NULL AND a.ASIAN_WRITE_IN != '') THEN 'Asian'
            WHEN (a.BLACK_OR_AFRICAN_AMERICAN_DETAILED_CATEGORIES IS NOT NULL /* Add check for non-empty VARIANT if needed */) OR (a.BLACK_OR_AFRICAN_AMERICAN_WRITE_IN IS NOT NULL AND a.BLACK_OR_AFRICAN_AMERICAN_WRITE_IN != '') THEN 'Black or African American'
            ...
            WHEN (a.MIDDLE_EASTERN_OR_NORTH_AFRICAN_DETAILED_CATEGORIES IS NOT NULL /* Add check for non-empty VARIANT if needed */) OR (a.MIDDLE_EASTERN_OR_NORTH_AFRICAN_WRITE_IN IS NOT NULL AND a.MIDDLE_EASTERN_OR_NORTH_AFRICAN_WRITE_IN != '') THEN 'Middle Eastern or North African'
            WHEN (a.NATIVE_HAWAIIAN_OR_PACIFIC_ISLANDER_DETAILED_CATEGORIES IS NOT NULL /* Add check for non-empty VARIANT if needed */) OR (a.NATIVE_HAWAIIAN_OR_PACIFIC_ISLANDER_WRITE_IN IS NOT NULL AND a.NATIVE_HAWAIIAN_OR_PACIFIC_ISLANDER_WRITE_IN != '') THEN 'Native Hawaiian or Pacific Islander'
            WHEN (a.WHITE_DETAILED_CATEGORIES IS NOT NULL /* Add check for non-empty VARIANT if needed */) OR (a.WHITE_WRITE_IN IS NOT NULL AND a.WHITE_WRITE_IN != '') THEN 'White'
