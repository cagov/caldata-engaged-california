with link_metrics as (select * from TRANSFORM_ENGCA_PRD.bitly.stg_bitly_links_metrics_api),

bitlinks as (select * from TRANSFORM_ENGCA_PRD.bitly.stg_bitly_links_api)
